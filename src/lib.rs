...
fn py_lens(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    #[pyfunction]
    fn windowed_stdev_single<'py>(py: Python<'py>, py_img: PyReadonlyArray3<u8>, window_size: usize) -> &'py PyArray3<u8> {
    ...
    fn windowed_stdev<'py>(py: Python<'py>, py_img: PyReadonlyArray3<u8>, window_type: window::WindowShape) -> &'py PyArray3<u8> {
